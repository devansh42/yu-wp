...
**/
create table if not exists yu_wp_data.orders(oid int,nid varchar(50),temp_domain varchar(50),site_status tinyint default 0,ssl_status tinyint default 0,otype char(3),domain varchar(50) ,domains varchar(1000));
